...
// Structure representing weapon parameters
struct weaponParms {
    float forward[3];
    float right[3];
    float up[3];
...
// Structure representing missile fire parameters
...
// Enumeration for player hand index
...
// Enumeration for weapon classes
enum weapClass_t {
    WEAPCLASS_RIFLE = 0x0,
...
// Enumeration for weapon icon ratio types
